...
public class AppState {
    ...
    private boolean autoUploadClipboardFiles = false;
    ...
    public AppState copy() {
        ...
        next.autoUploadClipboardFiles = autoUploadClipboardFiles;
    ...
    public boolean isAutoUploadClipboardFiles() {
        return autoUploadClipboardFiles;
    }

    public void setAutoUploadClipboardFiles(boolean autoUploadClipboardFiles) {
        this.autoUploadClipboardFiles = autoUploadClipboardFiles;
    }
